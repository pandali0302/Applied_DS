...
def get_scatter_chart(entered_site, entered_payload):  
    ...
    if entered_site == 'ALL': 
        fig2 = px.scatter(filtered_df, y = 'class', x = 'Payload Mass (kg)', color = 'Booster Version Category', 
        title = 'Correlation between Payload and Success for all Sites')
        return fig2
    else: 
        filtered_df_2 = filtered_df[filtered_df['Launch Site'] == (entered_site)] 
        fig2 = px.scatter(filtered_df_2, y= 'class', x = 'Payload Mass (kg)', color = 'Booster Version Category', 
